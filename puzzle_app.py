...
def _to_data_uri(path: Path, max_dim: int = 1600, quality: int = 90) -> dict[str, str]:
    ...
    return {"name": path.stem.replace("_", " ").replace("-", " ").title(), "url": f"data:image/jpeg;base64,{encoded}"}
...
<style>
  ...
  * {{ -webkit-tap-highlight-color: transparent; }}
  ...
  .legal-note {{ margin-top: 12px; color: var(--muted); font-size: .82rem; }}
        ...
        <section class="card pad">
          <div class="controls">
            <div class="control">
              ...
              <div class="helper">Each design becomes a playable branded moment with a direct product path.</div>
            </div>
        ...
        <section class="card pad">
          <div class="mini-list">
            <div class="mini-item">
              ...
              <div class="mini-copy"><strong>More premium Designs in Our Shop</strong></div>
            </div>
        ...
        <section class="board-card card">
          <div class="board-head">
            <div>
              ...
              <div class="board-note">Swap tiles until the full mandala comes together. Tap two tiles on mobile, or drag and drop on desktop.</div>
            </div>
            ...
            <div id="overlay" class="overlay">
              <div class="overlay-box">
                ...
                <div class="overlay-actions">
                  <a id="shopBtn" target="_blank" class="cta-link btn-success">Shop This Design</a>
